...
# uses format string to replace with snow.
puts "Its fleece was white as %s." % 'snow'
puts "And everywhere that Mary went."

# prints 10 dots to terminal.
puts "." * 10  # what'd that do?

# assigning variables for use below.
end1 = "C"
end2 = "h"
end3 = "e"
end4 = "e"
...
# puts adds newline to end of output whereas print does not.
