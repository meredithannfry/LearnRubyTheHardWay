# Hashes 'aka' Dictionaries. Unlike an array that requires you to use numbers to find out what's in Array. 
# A hash allows you to use anything, a hash associates one thing to another like a key/value pair.
